    ...
    def run_pipeline(self):
        ...
        for ticket in tickets:
            ...
            if failures:
                ...
                # Check if this payload is destined for Meta and it's a New Campaign
                if tkt_mapped.get("platform") == "Meta" and "New Campaign" in req_type:
                    print(" -> 🚀 Initiating Live API Deployment to Meta Sandbox...")
                    meta = MetaAPIClient()
                    
                    # Extract the properly built taxonomy and budget
                    campaign_taxonomy = cmp_mapped.get("campaign_name", "UNKNOWN")
                    # We can use the taxonomy generated by our engine if we want, or just the mapped name
                    for pl in payloads:
